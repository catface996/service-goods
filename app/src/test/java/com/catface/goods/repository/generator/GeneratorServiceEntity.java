package com.catface.goods.repository.generator;
...
import com.catface.goods.BaseTest;
...
public class GeneratorServiceEntity extends BaseTest {
    ...
    private final String packageName = "com.catface.goods.repository";
    ...
    public void generateAllCode() {
        generateByTables(serviceNameStartWithI, packageName, "goods_sku_snap");
    }

    @Test
    public void generateOnlyEntity() {
        generateEntity(serviceNameStartWithI, packageName, "category");
    }
