 ...
 */
@Data
@ApiModel(description = "删除类目请求")
public class DeletePrivateCategoryRequest {
    ...
    @ApiModelProperty(value = "待删除的类目ID", required = true, example = "121212")
    @NotNull(message = "待删除的类目ID不能为空")
